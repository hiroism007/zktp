                        ...
                        <Box>
                            <Box marginBottom={4}>
                                <Box marginBottom={2}>
                                    ...
                                    >
                                        ZKTokenProof is a ZK based
                                        ticketing/token proof solution
                                    </Typography>
                                    <Typography
                                        variant="h6"
                                        component="p"
                                        ...
                                        align={"center"}
                                    >
                                        that enables users without revealing
                                        their wallet addresses prove ownership
                                        of NFTs.
                                    </Typography>
                                    <Typography
                                        variant="h6"
                                        ...
                                        align={"center"}
                                    >
                                        For example, Anyone can easily mange
                                        limited events where only those with a
                                        particular NFT.
                                    </Typography>
                                    <Typography
                                        variant="h6"
                                        ...
                                        align={"center"}
                                    >
                                        Participants can prove that they have
                                        one of the NFT without revealing their
                                        wallet addresses.
                                    </Typography>
                                </Box>
                            </Box>
